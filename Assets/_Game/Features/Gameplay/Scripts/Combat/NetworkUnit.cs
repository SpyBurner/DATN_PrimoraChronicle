...
public class NetworkUnit : NetworkBehaviour
{
    ...
    public bool MoveToTile(int targetP, int targetQ, bool ignorePathfinding = false)
    {
        ...
        if (NetworkGameplayManager.Instance == null) return false;
    ...
    private int InterceptDamageFromTileEffects(int rawDamage)
    {
        ...
        if (tileEffect != null)
        {
            ...
            {
                if (tileEffect.EffectType.ToString() == "Corrupted")
                {
                    rawDamage += 5;
                }
            }
    ...
    private bool IsPathClear(int p1, int q1, int p2, int q2)
    {
        ...
        for (int i = 1; i < dist; i++)
        {
            ...
            if (NetworkGameplayManager.Instance != null && NetworkGameplayManager.Instance.FindUnitAtTile(currP, currQ) != null)
            {
                return false;
            }
        }
