...
public interface ICardDetailModel : IModel
{
    ...
    Observable<string> SkillName { get; }
    Observable<string> SkillDescription { get; }
    Observable<string> SkillPattern { get; }
    ...
    void SetSkill(string name, string desc, string pattern);
}
